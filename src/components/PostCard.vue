...
<template>
	<div
		class="bg-white border-slate-900 border-2 shadow-slate-900 shadow-[0_3px_0px] rounded-lg p-6"
	>
		<div class="flex items-center">
			<div class="w-[45px] h-[45px]">
				<template v-if="props.post.user.photo">
					<img
						class="w-full rounded-full border-slate-900 border-2"
				...
				<template v-else>
					<span
						class="w-full h-full border-slate-900 border-2 rounded-full flex justify-center items-center"
					>
